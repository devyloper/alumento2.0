	...
	<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<p>Permanent Location: <b><?php echo $native ?></b>, <b><?php echo $navstate ?></b></p>
			</div>
			<div class="col-md-6">
				<p>Enrollement No: <b><?php echo $enroll_no ?></b></p>
				<p>Job Sector: <b><?php echo $companysector ?></b></p>
				<p>Working at: <b><?php echo $connected_to ?></b></p>
				<p>Position : <b><?php echo $pos ?></b></p>
				
				<p>Current Location: <b><?php echo $companyloc ?></b></p>
				<p>Company Location: <b><?php echo $comploc ?></b></p>
